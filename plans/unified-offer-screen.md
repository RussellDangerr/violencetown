...
exist and were abandoned**, with no supersede notes. The spec for what actually shipped lived only on
the `plan` branch until 2026-09-24. It is now `plans/chapter-two-downtown-canyon-and-cohesion.md`
(§Trade-window decisions at :81, §Phase 6a–6e at :299–417).
