...
export const SHEETS = {
    ...
    // Procedural 9-slice UI panel — 96×288 atlas with three 96×96 variants
    // stacked vertically (base / dark / glow). Generated by tools/gen_ui_panel.py;
    // see ui-sprites.js drawPanelBig() for how the 32×32 cells get sampled.
    // frameW/frameH match the cell size so drawFrame would work; we mostly
    // access via drawRegion since the 9-slice math wants explicit pixel rects.
